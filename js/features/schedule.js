...
const HOME_ACTIVITIES = [
  ...
  { label: "분리수거",       image: "./images/home_recycling.png", emoji: "♻️" },
  { label: "파리바게트",     image: "./images/home_paris_baguette.png", emoji: "🥐" },
  { label: "산책",           image: "./images/home_walk.png", emoji: "🚶" },
  { label: "놀이터",         image: "./images/home_playground.png", emoji: "🛝" },
  { label: "하나로마트",     image: "./images/home_hanaro_mart.png", emoji: "🛒" },
  { label: "소방서",         image: "./images/home_fire_station.png", emoji: "🚒" },
  { label: "우체국",         image: "./images/home_post_office.png", emoji: "📮" },
